...
#include "src/ant_colony_opt_pm/ant_system_pm_par.h"
...
int main(int argc, char **argv) {
    ...
    if (number_of_algorithm == "0") {
        ...
        ant_system_pm_par(thread_number, graph_value, opt);
    } else if (number_of_algorithm == "2") {
        ant_system_pm_min_par(thread_number, graph_value_sum, graph_value, opt);
    }
